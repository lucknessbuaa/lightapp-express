$(function(){
	...
	$("#submitButton").bind("click",function(){
		...
		$.post("/app/send/add",data,function(json){
			if(json.ret_code==0){
				$('div.well').html('<p><b>订单已提交成功！</b></p> <p>您可以在 <a href="profile">个人中心</a> 标签页下的链接 <br><a href="recent">我的订单</a> 中跟踪您的订单处理状态</p>'
	...
	$(".feeRule-link").bind("click",function(){
		$('#price-modal').modal({backdrop:true,keyboard:true,show:true});
	});
});
